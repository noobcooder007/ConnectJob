                        ...
                        <div class="quest-frec-box-item">
                            <div style="display: flex">
                                <div>
                                    ...
                                    <div class="quest-content">
                                        <label>Ciudad</label>
                                            ...
                                            <input id="sign-input" type="text" name="city" placeholder="Ciudad" value="<?php echo $city; ?>" require>
                                        
                                    </div>
                                    <div class="quest-content">
                                        <label>Estado</label>
                                        
                                            <input id="sign-input" type="text" name="state" placeholder="Estado" value="<?php echo $state; ?>" require>
                                        
                                    </div>
                                    <div class="quest-content">
                                        <label>Introduce un numero de telefono o celular</label>
                                        
                                            <input id="sign-input" type="tel" name="tel" placeholder="XXX-XXX-XXXX" maxlength="12" value="<?php echo $telephone; ?>" require>
                                    ...
                                    <div class="quest-content" style="display: block">
                                        ...
                                        <select name="genre" require>
                                            ...
                                            <option <?php if ($genre=='0') echo 'selected="selected"' ?> >Masculino</option>
                                            <option <?php if ($genre=='1') echo 'selected="selected"' ?> >Femenino</option>
                                        </select>
                                    </div>
                                    <div class="quest-content">
                                ...
                                <div style="margin-left: 40px;">
                                    ...
                                    <div class="quest-content">
                                        <input type="file" accept="image/jpeg" name="file-input" id="file-input" require/>
                                        <script>
